...
int main(int argc, char **argv){
	...
	fprintf(log,"Number 1 with 5 tickets %d has started at %s\n",pid,ctime(&current_time));
	...
	printf("Number 1 with 5 tickets: %d has finished... \n",pid);
	fprintf(log,"Number 1 with 5 tickets:%d has finished at %s\n",pid,ctime(&current_time));
}
