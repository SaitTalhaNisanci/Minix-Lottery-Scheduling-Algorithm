...
EXTERN struct schedproc {
	...
	unsigned tickets; //Holds the amount of tickets
	unsigned torpil; // if this is 1 then kernel will give	run this.
	unsigned is_sys_proc; // if this is 1 then system process.
